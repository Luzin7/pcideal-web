          ...
          <section>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Absolutamente. Nosso algoritmo é imparcial e prioriza sempre o
                  melhor custo-benefício para o usuário. Não favorecemos nenhuma
                  marca ou loja específica em nossas recomendações.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Sim, oferecemos três opções de configuração e você pode
